...
public final class Database {
    ...
    public static Database fromEnvironment() {
        ...
        return new Database(
                value("LIBRARY_DB_URL", defaults),
                value("LIBRARY_DB_USER", defaults),
    ...
    public void initialize() {
        try (Connection connection = connect()) {
            ...
            ensureIndex(
                    connection, "reservations", "idx_reservations_book_status", "book_id,status");
        } catch (Exception e) {
    ...
    private static void ensureIndex(
            Connection connection, String table, String index, String columns) throws SQLException {
